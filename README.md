...
![Inventory Management](https://img.shields.io/badge/C%23-.NET-blue) 
![Windows Forms](https://img.shields.io/badge/UI-Windows%20Forms-green)

## 📌 Overview
Invenza is a **modern inventory and sales management solution** built with C# and Windows Forms. Designed for SMEs, it eliminates manual tracking errors and provides real-time business insights.
...
2. **Installation**:
   ```bash
   git clone https://github.com/yourusername/invenza.git
   cd invenza
   open RegisterForm.sln
Build & Run:
